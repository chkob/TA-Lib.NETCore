...
namespace TALib.NETCore.HighPerf
{
    ...
    {
        public static RetCode ShortLine(
            ...
            out int outNbElement)
        {
            ...
            int lookbackTotal = ShortLineLookback();
        ...
        public static int ShortLineLookback() =>
            Math.Max(CandleAvgPeriod(CandleSettingType.BodyShort), CandleAvgPeriod(CandleSettingType.ShadowShort));
    }
}
