...
namespace TALib.HighPerf
{
    public static partial class Lib
    {
            ...
            int optInTimePeriod = 30)
        {
            ...
            RetCode retCode = HighPerf.Lib.INT_EMA(ref inReal, startIdx - lookbackEMA, endIdx, ref firstEMA, out var firstEMABegIdx,
            ...
            retCode = HighPerf.Lib.INT_EMA(ref firstEMA, 0, firstEMANbElement - 1, ref secondEMA, out var secondEMABegIdx,
