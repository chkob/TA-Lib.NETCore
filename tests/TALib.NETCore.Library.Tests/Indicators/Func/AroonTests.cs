...
namespace TALib.NETCore.Library.Tests.Indicators.Func
{
    public class AroonTests
    {
        ...
        public void AroonDouble()
        {
            ...
            double[] outputRealUp = new double[100];
            double[] outputRealDn = new double[100];

            // Act
            var actualResult = Core.Aroon(
                high,
                low,
                startIdx,
                endIdx,
        ...
        public void AroonDecimal()
        {
            ...
            decimal[] outputRealUp = new decimal[100];
            decimal[] outputRealDn = new decimal[100];
