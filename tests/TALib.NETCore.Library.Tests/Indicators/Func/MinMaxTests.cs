...
namespace TALib.NETCore.Library.Tests.Indicators.Func
{
    public class MinMaxTests
    {
        ...
        public void MinMaxDouble()
        {
            ...
            double[] outputMin = new double[100];
            double[] outputMax = new double[100];

            // Act
            var actualResult = Core.MinMax(
                real,
                startIdx,
                endIdx,
                outputMin,
        ...
        public void MinMaxDecimal()
        {
            ...
            decimal[] outputMin = new decimal[100];
            decimal[] outputMax = new decimal[100];
